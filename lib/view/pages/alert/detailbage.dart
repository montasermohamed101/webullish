...
class DetailPage extends StatelessWidget {
 ...
 // var controller = Get.put(HomeController());
  ...
  Widget build(BuildContext context ) {
    return GetBuilder<SwingAlertController>(
      ...
      Scaffold(
        ...
        appBar: AppBar(
          ...
          title: MyText(
            //text: dinoData!.name!,
            text: controller.swingAlertsModel!.notifications![0].name!,
          ...
          leading: IconButton(
            ...
            icon: Flexible(
              flex: 3,
              child: Image.network(  controller.swingAlertsModel!.notifications![0].image
                  == null ?
                    "https://cdn.hswstatic.com/gif/why-is-sky-blue.jpg"
                  : controller.swingAlertsModel!.notifications![0].image!
              ),
            ),
                  ...
                  child: Chewie(
                    controller: ChewieController(
                      videoPlayerController: VideoPlayerController.network(
                        //dinoData!.url!
                       //   controller.swingAlertsModel!.notifications![1].video! ?? "https://www.youtube.com/watch?v=YMx8Bbev6T4"
                          controller.swingAlertsModel!.notifications![1].video!
                              == null?
                          "https://www.youtube.com/watch?v=YMx8Bbev6T4"
                              : controller.swingAlertsModel!.notifications![0].video!
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      controller.swingAlertsModel!.notifications![0].name!,
                      //dinoData!.name!,
                      style: TextStyle(
                    ...
                    Text(
                      controller.swingAlertsModel!.notifications![0].description!,
