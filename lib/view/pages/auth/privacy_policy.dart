...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: MyText(text: 'Privacy Policy',color: AppColors.ancientColor,
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              MyText(text: 'Privacy Policy for Webullish.com LLC', color: AppColors.ancientColor,
                fontWeight: FontWeight.bold,
                size: 17,
  ...
  // }
//onTap
//   final urls = text.split('WWW.');
//   if (urls.length > 1) {
//   final url = 'https://www.${urls[1].trim()}';
//   launchUrl(url);
//   }
//
}
